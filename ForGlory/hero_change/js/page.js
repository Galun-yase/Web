...
var newBeeHeroDataFill = (function(){
    ...
    util.init = function(dataNum,roleName,roleId){
        (typeof roleIdPair != "object") ? util.jsLoader("//game.gtimg.cn/images/yxzj/web201706/js/heroid.js",util.pickHeroVideo(dataNum,roleName,roleId)):util.pickHeroVideo(dataNum,roleName,roleId);
    };
